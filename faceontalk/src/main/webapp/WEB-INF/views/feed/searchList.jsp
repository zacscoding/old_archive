		...
		<div class="text-center">
			<ul class="pagination">
				<c:if test="${pageMaker.prev}">
					<li><a
						href="searchList${pageMaker.makeSearch(pageMaker.startPage-1)}">«</a></li>
				</c:if>
				
				<c:if test="${not empty pageMaker.startPage}">
				...
				<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
					<li><a href="searchList${pageMaker.makeSearch(pageMaker.endPage +1)}">»</a></li>
				</c:if>
			</ul>
		</div>
	</div><!-- .//페이징 처리 끝-->
