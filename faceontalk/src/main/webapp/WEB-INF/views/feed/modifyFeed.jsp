...
<div class="container">	
	...
	<div class="row">
	<!-- register form -->
	<form  role="form" id="modifyForm" class="form-horizontal"  action="/feed/modifyFeed" method="POST">
	<input type="hidden" name="feed_no" value="${vo.feed_no}">
	...
	<input type="hidden" name="file_name" id="file_name">
			...
			<div class="form-group">        
            	<div class="fileDrop col-sm-4 col-lg-4" style="display:none">&nbsp;<Strong>Drag and drop</Strong> image here</div>
				<div class="uploadedPic col-sm-4 col-lg-4" style="display:block">
					<div><img src="/displayImage?type=f&fileName=${vo.file_name}"/>
				 	<small id='file_name' data-src="${vo.file_name}">X</small></div>
				</div>
			</div>
