...
<div class="container">
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<form role="form" action="/reviews/register" method="post"> 
				<input type="hidden" name="review_writer" value="hyungssi71"> 
				<input type="hidden" name="product_no_fk" value="1"> 
								...
								<div class="row">
									<div class="span4">									
										...
										<div class="row">
											...
											<input type="text" class="form-control" name="review_title" placeholder="TITLE">
											</div>
										</div>
										<div class="row">																												
											<div class="col-md-9">
												<!-- content -->
	                							<textarea class="form-control" id="content" name="review_content" placeholder="Content" rows="8"></textarea>
	              							</div>
              							</div>										
									</div>
								</div>
