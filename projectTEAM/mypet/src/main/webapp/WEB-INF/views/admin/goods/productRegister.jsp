...
function getFileInfo(fullName){
	...
	if(checkImageType(fullName)){
		imgsrc = "/goods/productDisplayFile?fileName="+fullName;
		fileLink = fullName.substr(14);
		
		var front = fullName.substr(0,12); // /2015/07/01/ 
		var end = fullName.substr(14);
		
		getLink = "/goods/productDisplayFile?fileName="+front + end;
...
$(".fileDropMain").on("drop", function(event){
	...
	$.ajax({
		  url: '/goods/productUploadAjaxMain',
		  data: formData,
		  dataType:'text',
		  processData: false,
		  contentType: false,
