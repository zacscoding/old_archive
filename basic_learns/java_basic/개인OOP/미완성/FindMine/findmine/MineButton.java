...
public class MineButton extends JButton{	
	//static fields
	private static ImageIcon flagImage = new ImageIcon("./src/images/flag.jpg");
	private static ImageIcon mineImage = new ImageIcon("./src/images/mine.jpg");	
	private static ImageIcon wrongCheckImage = new ImageIcon("./src/images/wrongCheck.jpg");
	private static ImageIcon[] numberImages = new ImageIcon[9];
	static{
		for(int i=0;i<numberImages.length;i++){
			numberImages[i] = new ImageIcon("./src/images/no"+i+".jpg"); 
		}		
	}	
