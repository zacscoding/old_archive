...
public class OrderController {
	private final String ORDER_PAGE = "??";
	...
	public String createOrderByOneProduct(Integer product_no, Integer quantity, Model model) throws Exception {
		OrderVO vo = orderService.createOrderByOneProduct(product_no, quantity);
	...
	public String createOrderByMultiProduct(int[] cartNumberArr, Model model) throws Exception {
		OrderVO vo = orderService.createOrderByMultiProduct(cartNumberArr);		
		return createOrder(vo,model);
	}
		
	//private method
	private String createOrder(OrderVO vo,Model model) {		
