...
public class AdminProductController {
	...
	public void read(@RequestParam("product_no") int product_no, @ModelAttribute("cri") Criteria cri,
	...
	public String remove(@RequestParam("product_no") int product_no, Criteria cri, RedirectAttributes rttr) throws Exception{
	...
	public void modifyPagingGET(@RequestParam("product_no") int product_no, @ModelAttribute("cri") Criteria cri, Model model) throws Exception{
		model.addAttribute(service.read(product_no));
	}
	
	@RequestMapping(value="/modifyPage", method = RequestMethod.POST)
	public String modifyPagingPOST(ProductVO product, Criteria cri, RedirectAttributes rttr) throws Exception{
